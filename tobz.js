...
module.exports = tobz = async (tobz, message) => {
	...
	if (isGroupMsg && AntiStickerSpam && !isGroupAdmins && !isAdmin && !isOwner){
        ...
        case prefix+'ttp2':
            ...
            await tobz.sendStickerfromUrl(from, `https://api.vhtear.com/textmaker?text=${ttp2t}&warna=${rttp2}&apikey=Jsieu8287362jshre82`)
            break
        case prefix+'ttg':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            ...
            try {
                if (quotedMsgObj == null) {
                    if (args.length === 1) return tobz.reply(from, `Kirim perintah *#ttg [ Teks ]*, contoh *#ttg aku bukan boneka*`, id)
                        await tobz.sendStickerfromUrl(from, `https://api.vhtear.com/textxgif?text=${body.slice(5)}&apikey=Jsieu8287362jshre82`)
                        limitAdd(serial)
                } else {
                    await tobz.sendStickerfromUrl(from, `https://api.vhtear.com/textxgif?text=${quotedMsgObj}&apikey=Jsieu8287362jshre82`)
                    limitAdd(serial)
                }
            } catch(e) {
                console.log(e)
        ...
        case prefix+'lovemessage':
            ...
            await tobz.sendFileFromUrl(from, `https://api.vhtear.com/lovemessagetext?text=${lovemsg}&apikey=Jsieu8287362jshre82`, 'lovemsg.jpg', '', id)
            break
        case prefix+'romance':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            ...
            await tobz.sendFileFromUrl(from, `https://api.vhtear.com/romancetext?text=${rmnc}&apikey=Jsieu8287362jshre82`, 'romance.jpg', '', id)
            break
        case prefix+'party':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            ...
            await tobz.sendFileFromUrl(from, `https://api.vhtear.com/partytext?text=${prty}&apikey=Jsieu8287362jshre82`, 'party.jpg', '', id)
            break
        case prefix+'silk':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            ...
            await tobz.sendFileFromUrl(from, `https://api.vhtear.com/silktext?text=${slkz}&apikey=Jsieu8287362jshre82`, 'silk.jpg', '', id)
            break
        case prefix+'blackpink':
            ...
            await tobz.sendFileFromUrl(from, `https://api.vhtear.com/blackpinkicon?text=${blpk}&apikey=Jsieu8287362jshre82`, 'blackpink.jpg', '', id)
            break
        case prefix+'thunder':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            ...
            await tobz.sendFileFromUrl(from, `https://api.vhtear.com/thundertext?text=${thndr}&apikey=Jsieu8287362jshre82`, 'thndr.jpg', '', id)
            break
        case prefix+'pornhub':
            if(isReg(obj)) return
            if(cekumur(cekage)) return
            ...
            if (argz.length >= 2) {
                ...
                tobz.sendFileFromUrl(from, `https://api.vhtear.com/pornlogo?text1=${lpornhub}&text2=${lpornhub2}&apikey=Jsieu8287362jshre82`)
        ...
        case prefix+'glitch':
            ...
            if (argz.length >= 2) {
                ...
                tobz.sendFileFromUrl(from, `https://api.vhtear.com/glitchtext?text1=${glitch1}&text2=${glitch2}&apikey=Jsieu8287362jshre82`)
                await limitAdd(serial)
            } else {
...
${desc}`)
        ...
        case prefix+'pinterest':
            ...
            const ptrst = await fetch(`https://api.vhtear.com/pinterest?query=${ptrsq}&apikey=Jsieu8287362jshre82`)
        ...
        case prefix+'loli':
            ...
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            if (isLimit(serial)) return tobz.reply(from, `Maaf ${pushname}, Kuota Limit Kamu Sudah Habis, Ketik ${prefix}limit Untuk Mengecek Kuota Limit Kamu`, id)
            const loli = await axios.get(`https://api.vhtear.com/randomloli&apikey=Jsieu8287362jshre82`)
...
🌐️ *URL*: ${url}`
        ...
        case prefix+'jadwalsholat':
            ...
            const jadwalShalat = await axios.get(`https://api.vhtear.com/jadwalsholat?query=${daerah}&apiKey=Jsieu8287362jshre82`)
        ...
        case prefix+'quran':
            ...
            const qura = `https://api.vhtear.com/quran?no=${args[1]}&apikey=Jsieu8287362jshre82`
        ...
        case prefix+'ytsearch':
            ...
            tobz.reply(from, mess.wait, id)
            try {
                const response2 = await fetch(`https://api.vhtear.com/youtube?query=${encodeURIComponent(ytsher)}&apikey=Jsieu8287362jshre82`)
                if (!response2.ok) throw new Error(`unexpected response ${response2.statusText}`)
                const jsonserc = await response2.json()
                const { result } = await jsonserc
        ...
        case prefix+'shopee':
            ...
            tobz.reply(from, mess.wait, id)
            try {
                const dataplai = await axios.get(`https://api.vhtear.com/shopee?query=${shopek}&count=5&apikey=Jsieu8287362jshre82`)
        ...
        case prefix+'playstore':
            ...
            tobz.reply(from, mess.wait, id)
            try {
                const dataplai = await axios.get(`https://api.vhtear.com/playstore?query=${keywotp}&apikey=Jsieu8287362jshre82`)
        ...
        case prefix+'newstickerline':
            ...
            tobz.reply(from, mess.wait, id)
            try {
                const stcline = await fetch(`https://api.vhtear.com/newsticker?apikey=Jsieu8287362jshre82`)
        ...
        case prefix+'news':
            ...
            tobz.reply(from, mess.wait, id)
            try {
                const response2 = await fetch(`https://api.vhtear.com/beritaterbaru&apikey=Jsieu8287362jshre82`)
                if (!response2.ok) throw new Error(`unexpected response ${response2.statusText}`)
        ...
        case prefix+'jadwalbola':
            ...
            tobz.reply(from, mess.wait, id)
            try {
                const jdbola = await fetch(`https://api.vhtear.com/jadwalbola&apikey=Jsieu8287362jshre82`)
        ...
        case prefix+'ssphone':
            ...
            tobz.sendFileFromUrl(from, `https://api.vhtear.com/ssweb?link=${ssphone}&type=phone&apikey=Jsieu8287362jshre82`, 'ssphone.jpg', '', id)
            await limitAdd(serial)
            break
        case prefix+'sspc':
            if(isReg(obj)) return
            ...
            tobz.sendFileFromUrl(from, `https://api.vhtear.com/ssweb?link=${sspc}&type=pc&apikey=Jsieu8287362jshre82`, 'sspc.jpg', '', id)
            await limitAdd(serial)
            break
	case prefix+'bitly':
            if(isReg(obj)) return
        ...
        case prefix+'ytmp4':
            ...
            try {
                tobz.reply(from, mess.wait, id)
                const ytvh = await fetch(`http://api.vhtear.com/ytdl?link=${args[1]}&apikey=Jsieu8287362jshre82`)
        ...
        case prefix+'play':
            ...
            try {
                ...
                const webplay = await fetch(`https://api.vhtear.com/ytmp3?query=${serplay}&apikey=Jsieu8287362jshre82`)
        ...
        case prefix+'ytmp3':
            ...
            try {
                tobz.reply(from, mess.wait, id)
                const vhtearyt3 = await fetch(`https://api.vhtear.com/ytdl?link=${args[1]}&apikey=Jsieu8287362jshre82`)
	...
	case prefix+'moddroid':
        ...
        case prefix+'wiki':
            ...
            const wiki = await axios.get(`https://api.vhtear.com/wikipedia?query=${queryz_}&apikey=Jsieu8287362jshre82`)
            if (wiki.data.error) {
        ...
        case prefix+'kbbi':
            ...
            const kbbl2 = await axios.get(`https://api.vhtear.com/kbbi?query=${kbbl}&apikey=Jsieu8287362jshre82`)
...
*Text : ${swrt}*`
         ...
         case prefix+'tahta':
             ...
             await tobz.sendFileFromUrl(from, `https://api.vhtear.com/hartatahta?text=${jreng}&apikey=Jsieu8287362jshre82`,`${jreng}.jpg`,`Harta Tahta ${jreng}`, id)        
             await limitAdd(serial)
             break
