...
║├「 *INFORMATION* 」
║│
║│ *Nama BOT : HITMAN-MIKA*
║│ *Versi BOT : 4.0*
║│ *CREATOR : HITMAN*
║│ *No OWNER : wa.me/6282156986313*
║│*Total User : ${87 + pendaftar.length} User Registered
║╰───────
║╭───────
║├「 *USER STATUS* 」
║│
...
║│ *Pangkat :「 GrandMaster! 」*
║│ *Prefix :「 ${prefix} 」*
║│ *Total user* : ${871 + pendaftar.length} User Registered
║╰───────
║╭───────          
║├「 *LIST MENU* 」
║│
...
Contoh : *${prefix}googlesearch siapa itu HITMAN*
...
exports.info = info
const snk = () => {
    return `Syarat dan Ketentuan Bot *HITMAN*
